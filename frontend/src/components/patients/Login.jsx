...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      navigate('/patients/dashboard'); // Ensure your App.jsx router matches this route
    } catch (err) {
      console.log(err);
  ...
  return (
    <div style={{backgroundColor:"#79D7BE"}} className="flex justify-center items-center min-h-screen relative">
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg transition-transform transform hover:scale-110 hover:shadow-2xl">
        <h1 className="text-3xl font-bold text-center mb-4 text-gray-800">Patient Login</h1>
